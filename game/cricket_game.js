...
// 			}
// 		}
// 		else if ($(players.players[0].batsman_innings.scores).length > 0) 
// 		{
...
// 			players.players[0].player_type = 'bowler';
// 			players.players[1].player_type = 'batsman';
// 			undo_change_player( players.players[players.current] );

// 			$(oppScoreSection).text('');
// 			$(gameScoreSection).text(players.players[1].batsman_innings.runs_scored);
// 			$(gameWicketsSection).text(players.players[0].bowler_innings.wickets_left);

// 			var wickets = players.players[0].bowler_innings.wickets_left;
...
// 				$(wicketScoreSection[i]).css('opacity', '0.2');
// 			}
// 			for (var j = 0; j < players.players[0].bowler_innings.wickets.length; j++) 
// 			{
// 				var last_wicket = players.players[0].bowler_innings.wickets[j].wicket;
// 				var last_score = players.players[0].bowler_innings.wickets[j].score;
// 				var element = document.getElementById(last_wicket);

// 				$(element).text(last_score);
				
// 			}
// 		}
// 		$(gameScoreSection).text(players.players[1].batsman_innings.runs_scored);
// 		$(gameWicketsSection).text(players.players[0].bowler_innings.wickets_fallen);
// 	}
...
// 			}
// 		}
// 		$('#game_score').text(player.batsman_innings.runs_scored);
// 	}
// 	dart = 2;
// 	$(thirdSection).text('');
// }
...
// 			{
// 				undo_wicket( player, 25 );
// 			}
// 			else if (last_text == '2 run outs')
// 			{
// 				undo_wicket( player, 50 );
// 			}
// 		}
// 	}
...
// function undo_wicket( player, score )
// {
// 	if (score == 25) 
// 	{
// 		if (player.player_type == 'bowler') 
...
// 	}
// 	// players.players[0].bowler_innings.wickets.pop();
// 	// players.players[1].batsman_innings.wickets.pop();

// 	if (players.players[0].bowler_innings.wickets_left > 10 || players.players[1].batsman_innings.wickets_left > 10) 
// 	{
// 		players.players[0].bowler_innings.wickets_left = 10;
// 		players.players[1].batsman_innings.wickets_left = 10;
// 	}

// 	// CHANGE THE OPACITY OF THE WICKET & SCORE SECTION - TO SHOW WHAT SCORE BATSMAN WAS ON FOR LAST WICKET TO FALL
// 	for (var i = 0; i < wicketSection.length; i++) 
// 	{
...
// 	{
// 		$('#totalSection').text(taken_wickets - 1);
// 		undo_wicket( player, last_score );
// 	}
