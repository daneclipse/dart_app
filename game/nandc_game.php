...
{
	header('game_setup.php?game=nandc');
}
...
<div class="game">
	...
	<div class="tic_scoreboard">
		<div class="third">
			<p class="names" id="first_player_name"></p>
		</div>
		<div class="third">
			<p class="scores" id="first_player_score">0</p>
			<p class="scores" id="second_player_score">0</p>
		</div>
		<div class="third">
			<p class="names" id="second_player_name"></p>
		</div>
	</div>

	<div class="target_board">
		<div class="inner_target row_one col_one diag_one" id="target_one"></div>
		<div class="inner_target row_one col_two" id="target_two"></div>
		<div class="inner_target row_one col_three diag_two" id="target_three"></div>
		<div class="inner_target row_two col_one" id="target_four"></div>
		<div class="inner_target row_two col_two diag_one diag_two" id="target_five"></div>
		<div class="inner_target row_two col_three" id="target_six"></div>
		<div class="inner_target row_three col_one diag_two" id="target_seven"></div>
		<div class="inner_target row_three col_two" id="target_eight"></div>
		<div class="inner_target row_three col_three diag_one" id="target_nine"></div>
	</div>
...
<div class="board" id="board">
	...
	<div class="game_buttons right" id="nandc_buttons">
		<button class="button green_button" id="new_board">new board</button>
		<button class="button red_button" id="reset">reset</button>
	</div><!-- CLOSE DIV WITH CLASS GAME BUTTONS -->
...
<script type="text/javascript">
	...
	var marker = localStorage['marker'];
	var boards = Number(localStorage['boards']);
	...
	function createPlayer( name, opponent, marker, boards )
	{
		var player = 
		{
			name: name,
	...
	function order_selection()
	{
		...
		submitOrder.onclick = function()
		{
			...
			if (x) 
			{
				...
				playerOrder.remove();
				$(this).remove();
				$.getScript('game/nandc_targets.js');
				$.getScript('game/nandc_game.js');
			}
		}
	}

	createPlayer( user_name, opp_name, marker, boards );
	createPlayer( opp_name, user_name, opp_marker, boards );
	order_selection();
