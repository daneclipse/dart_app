...
<style type="text/css">
	...
	.inner_scoreboard:nth-of-type(2)
	{
		width: 40%;
	}
...
<div class="game">
	<div class="scoreboard" id="cricketScoreboard">
		...
		<div class="inner_scoreboard"><p id="targetSection" style="color:#fff;"></p></div>
	  ...
	  <g transform="scale(1,-1)">
	    ...
	    <g id="dartboard">
	      ...
	      <g class="scalable">
		      ...
		      <circle class="red double scaleTwo" data-value="50" r="6.85" stroke-width="0" id="bullseye"/>
		  </g><!-- BULLSEYE AREA -->
...
<script type="text/javascript">
	...
	function createPlayer( name )
	{
		...
		$('#targetSection').text('Aim at ' + player.target_num);
	}

	createPlayer('<?=$user_username;?>');
	$.getScript('game/rtw_game.js');
